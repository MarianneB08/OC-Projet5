...
function totalArticle(product, productStorage) {
    ...
    totalQuantityProduc.innerHTML = totalQuantityProduc.innerHTML + productStorage.quantite;
   ...
   totalPrix.innerHTML = totalPrix.innerHTML + product.price * productStorage.quantite;
}
